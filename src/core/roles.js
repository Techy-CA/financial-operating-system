...
const P = {
  founder:    { dashboard:{r:1}, customers:{c:1,r:1,u:1,d:1}, vendors:{c:1,r:1,u:1,d:1}, products:{c:1,r:1,u:1,d:1}, quotations:{c:1,r:1,u:1,d:1,s:1}, invoices:{c:1,r:1,u:1,d:1,s:1,e:1}, collections:{r:1,s:1}, payments:{c:1,r:1,u:1,d:1}, expenses:{c:1,r:1,u:1,d:1}, ledger:{r:1,e:1}, gst:{r:1,e:1}, reports:{r:1,e:1}, settings:{c:1,r:1,u:1,d:1}, team:{c:1,r:1,u:1,d:1} },
  admin:      { dashboard:{r:1}, customers:{c:1,r:1,u:1,d:1}, vendors:{c:1,r:1,u:1,d:1}, products:{c:1,r:1,u:1,d:1}, quotations:{c:1,r:1,u:1,d:1,s:1}, invoices:{c:1,r:1,u:1,d:1,s:1,e:1}, collections:{r:1,s:1}, payments:{c:1,r:1,u:1}, expenses:{c:1,r:1,u:1,d:1}, ledger:{r:1,e:1}, gst:{r:1,e:1}, reports:{r:1,e:1}, settings:{r:1,u:1}, team:{r:1} },
  accountant: { dashboard:{r:1}, customers:{r:1}, vendors:{r:1,u:1}, products:{r:1}, quotations:{r:1}, invoices:{c:1,r:1,u:1,e:1}, collections:{r:1,s:1}, payments:{c:1,r:1,u:1}, expenses:{c:1,r:1,u:1}, ledger:{r:1,e:1}, gst:{r:1,e:1}, reports:{r:1,e:1}, settings:{r:1} },
  sales:      { dashboard:{r:1}, customers:{c:1,r:1,u:1}, vendors:{r:1}, products:{r:1}, quotations:{c:1,r:1,u:1,s:1}, invoices:{c:1,r:1,s:1}, collections:{r:1,s:1}, payments:{r:1}, expenses:{r:1}, reports:{r:1} },
  operations: { dashboard:{r:1}, vendors:{c:1,r:1,u:1}, products:{c:1,r:1,u:1}, expenses:{c:1,r:1,u:1}, payments:{c:1,r:1}, customers:{r:1}, invoices:{r:1}, ledger:{r:1}, gst:{r:1}, reports:{r:1} },
  auditor:    { dashboard:{r:1}, customers:{r:1}, vendors:{r:1}, products:{r:1}, quotations:{r:1}, invoices:{r:1,e:1}, collections:{r:1}, payments:{r:1}, expenses:{r:1}, ledger:{r:1,e:1}, gst:{r:1,e:1}, reports:{r:1,e:1}, settings:{r:1} },
};
